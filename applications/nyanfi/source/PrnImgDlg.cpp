...
void __fastcall TPrintImgDlg::FormShow(TObject *Sender)
{
	...
	CpsUpDown->Position = Printer()->Copies;
	...
	ScaleUpDown->Position		= IniFile->ReadIntGen(_T("PrintImgScale"),	100);
	ScaleEdit->Text 			= ScaleUpDown->Position;
	OfsXUpDown->Position		= IniFile->ReadIntGen(_T("PrintImgOfsX"));
	OfsXEdit->Text				= OfsXUpDown->Position;
	OfsYUpDown->Position		= IniFile->ReadIntGen(_T("PrintImgOfsY"));
	OfsYEdit->Text				= OfsYUpDown->Position;
	...
	StrMgnUpDown->Position		= IniFile->ReadIntGen(_T("PrintImgStrMgn"),	5);
	StrMgnEdit->Text			= StrMgnUpDown->Position;
