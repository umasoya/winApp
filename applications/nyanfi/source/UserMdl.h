...
//コンボボックスのオプションタグ
#define CBTAG_RGEX_V	0x10000000		//正規表現参照を表示
#define CBTAG_RGEX_E	0x20000000		//正規表現参照を有効
#define CBTAG_HISTORY	0x40000000		//履歴を持つ
#define CBTAG_NO_CALC	0x80000000		//電卓を表示しない

//エディットボックスのオプションタグ
#define EDTAG_RGEX_V	0x10000000		//正規表現参照を表示
#define EDTAG_RGEX_E	0x20000000		//正規表現参照を有効
#define EDTAG_DST_FMT	0x40000000		//振分先の書式文字列参照
#define EDTAG_NO_CALC	0x80000000		//電卓を表示しない
...
private:	// ユーザー宣言
	...
	TLabeledEdit* __fastcall GetActiveLabeledEdit();
...
public:		// ユーザー宣言
	...
	TStringList *RefRegExList;	//正規表現の簡易説明リスト
	...
	void __fastcall BeginSpuit(TPanel *pp, TImage *ip = NULL);
