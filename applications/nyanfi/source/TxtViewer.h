...
public:
	...
	__fastcall TTxtViewer(TForm *frm, TPaintBox *viewbox, TScrollBar *scrbar, UsrScrollPanel *sp, TStatusBar *stthdr, TPaintBox *ruler, TPanel *colref);
	...
	bool __fastcall ToLine(int lno);
