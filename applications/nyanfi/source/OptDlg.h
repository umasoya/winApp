...
__published:	// IDE で管理されるコンポーネント
	...
	TCheckBox *OneStpInDblCheckBox;
	TCheckBox *OpenAddDrvCheckBox;
	TCheckBox *OpenCmdPromptCheckBox;
	...
	void __fastcall RefSusieDirBtnClick(TObject *Sender);
	...
	void __fastcall DisableCol2ActionExecute(TObject *Sender);
	void __fastcall DisableCol2ActionUpdate(TObject *Sender);
...
private:	// ユーザー宣言
	...
	void __fastcall make_KeyList(TStrings *lst);
	...
	void __fastcall UpdateSpiListBox();
	...
	bool __fastcall check_DuplAliasMsg(UnicodeString alias, TCheckListBox *lp);
